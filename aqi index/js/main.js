                  ...
                  .position.lat}&lon=${item.position.long}&appid=${API}`
                                ...
                                .then(result => {
                                    ...
                                    let htmlText = `
                                            ...
                                            <ul>
                                                <li class="pollutionValue">CO : ${airitem.co}μg/m<sup>3</sup></li>
                                                <li class="pollutionValue">NO : ${airitem.no}μg/m<sup>3</sup></li>
                                                <li class="pollutionValue">NO<sub>2</sub> : ${airitem.no2}μg/m<sup>3</sup></li>
                                                <li class="pollutionValue">O<sub>3</sub> : ${airitem.o3}μg/m<sup>3</sup></li>
                                                <li class="pollutionValue">SO<sub>2</sub> : ${airitem.so2}μg/m<sup>3</sup></li>
                                                <li class="pollutionValue">pm2_5 : ${airitem.pm2_5}μg/m<sup>3</sup></li>
                                                <li class="pollutionValue">NH<sub>3</sub> : ${airitem.pm10}μg/m<sup>3</sup></li>
                                                <li class="pollutionValue">pm10 : ${airitem.so2}μg/m<sup>3</sup></li>
                                            </ul>
                                    `;
